...
> [Vibe Island](https://vibeisland.app)의 버그 신고, 기능 요청 및 커뮤니티 토론. Vibe Island은 Claude Code, Codex, Gemini CLI 등 AI 코딩 도구를 위한 macOS Notch 상태 패널입니다.
...
| 채널 | |
|------|---|
| [Discord](https://discord.gg/2GmjPVtc3d) | 실시간 채팅 |
| [X / Twitter](https://x.com/edwardluox) | 업데이트 소식 |
| 이메일 | hi@vibeisland.app |
...
iTerm2 · Terminal.app · Ghostty · Warp · VS Code · Cursor · Alacritty · Kitty · cmux · WezTerm 등
