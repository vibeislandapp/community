...
> [Vibe Island](https://vibeisland.app) のバグ報告、機能リクエスト、コミュニティディスカッション。Vibe Island は、Claude Code、Codex、Gemini CLI などの AI コーディングツール向け macOS Notch ステータスパネルです。
...
| チャンネル | |
|-----------|---|
| [Discord](https://discord.gg/2GmjPVtc3d) | リアルタイムチャット |
| [X / Twitter](https://x.com/edwardluox) | 更新情報 |
| メール | hi@vibeisland.app |

---

## 対応 CLI ツール

Claude Code · Codex · Gemini CLI · Cursor Agent · Droid · Qoder · Copilot · CodeBuddy · OpenCode

## 対応ターミナル

iTerm2 · Terminal.app · Ghostty · Warp · VS Code · Cursor · Alacritty · Kitty · cmux · WezTerm など
